...
public interface IProvider {
    ...
    public <T> Dto<T> delete(Class<T> cls, Object id);

    public <T> Dto<T> readById(Class<T> cls, Object id);
    public <T> Dto<List<T>> readAll(Class<T> cls);
    public <TFromEntity, TResultItem> Dto<List<TResultItem>> readByFlagFilter(ISelectParams<TFromEntity, TResultItem> queryParams, IColumnFlagFilter<TFromEntity> flagFilter);
    public <TFromEntity, TResultItem> Dto<List<TResultItem>> readWithValueFilter(ISelectParams<TFromEntity, TResultItem> queryParams, IColumnFilter<TFromEntity> filter);
