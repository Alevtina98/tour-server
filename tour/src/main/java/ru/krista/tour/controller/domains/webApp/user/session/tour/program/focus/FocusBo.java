...
public class FocusBo {
    ...
    public FocusBo () {
        ...
        this.target = new TargetBo(); // агрегация, т. к. можно выделить сущность Форма - может встречаться в различных версиях различных приложений - общее шаблонное решение (компонент)
    }
}
