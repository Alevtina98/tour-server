INSERT INTO tour.tour (id, name, description, code, code_js, form_name, form_caption, is_general_user)
VALUES (-1, 'Название', 'Описание', 'xml', 'js', 'MainForm',  'MainForm', true);

INSERT INTO tour.tour (id, name, description, code, code_js, create_date, change_date, form_name, form_caption, is_general_user)
